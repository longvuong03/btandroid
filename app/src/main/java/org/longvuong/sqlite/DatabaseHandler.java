...
public class DatabaseHandler extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        String create_students_table = String.format("CREATE TABLE %s(%s INTEGER PRIMARY KEY, %s TEXT, %s TEXT, %s TEXT)", TABLE_NAME, KEY_ID,
    ...
    public void addStudent(Student student) {
        ...
        values.put(KEY_ADDRESS, student.getDiachi());
        values.put(KEY_PHONE_NUMBER, student.getSdt());
